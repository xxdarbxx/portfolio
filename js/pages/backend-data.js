const PROJECT_GROUPS = [
  { title: 'School Management System', images: ['schoolmgmt1.PNG','schoolmgmt2.PNG','schoolmgmt3.PNG','schoolmgmt4.PNG'].map(f => ({ src: 'images/back-end/' + f })) },
  { title: "Yuna's Dental Clinic — Staff Portal", images: ['yunadental1.PNG','yunadental2.PNG','yunadental3.PNG'].map(f => ({ src: 'images/back-end/' + f })) },
